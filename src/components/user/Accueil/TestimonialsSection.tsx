...
const VideoCard: React.FC<VideoCardProps> = ({ testimonial, isCenter, onClick }) => {
  ...
  return (
    <div
      ...
      // ↓ réduit de 9/16 à environ 3/5 pour rester dans la ligne de flottaison
  ...
  return (
    <section id="temoignages" className="section overflow-hidden">
      <div className="container-page">
        ...
        {/* Grille 3 colonnes — ↓ max-w pour réduire la hauteur globale */}
        <Reveal delay={120}>
          <div className="mt-6 grid grid-cols-3 gap-4 items-center max-w-2xl mx-auto">
            {getOrder().map(({ t, isCenter, idx }) => (
              <VideoCard
                ...
                isCenter={isCenter}
                onClick={() => {
                  // ↓ CORRECTION : ouvre la modal quelle que soit la carte cliquée
                  //   (centre → modal directe, latérale → déplace le centre ET ouvre la modal)
                  if (isCenter) {
                    setActive(t);
                  } else {
                    setCenterIdx(idx);
                    setActive(t); // ← était manquant
                  }
                }}
              />
            ))}
        ...
        {/* Lien YouTube — remonté juste après les dots */}
        <Reveal delay={200}>
        ...
        <Reveal delay={240}>
          <div className="mt-16 pt-8 border-t border-border">
            ...
            {/* Footer — texte gauche + stats droite */}
            <div className="mt-5 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-semibold text-navy">{averageStars}/5</span>
