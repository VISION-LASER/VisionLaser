...
import React from "react";
import { LayoutGrid, Clock, Video, Image as ImageIcon } from "lucide-react";
import type { FilterType } from "../../../hooks/useActualites";
...
const OPTIONS: FilterOption[] = [
  ...
  { key: "recent",  label: "Plus récent", icon: Clock },
  { key: "video",   label: "Vidéos",     icon: Video },
  { key: "image",   label: "Articles",   icon: ImageIcon },
];
