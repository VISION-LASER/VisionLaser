            ...
            return (
              ...
              >
                {i < STEP_LABELS.length - 1 && (
                  <div
                    className="absolute right-0 top-1/2 h-px w-1/2 -translate-y-1/2"
                    style={{ background: isDone ? "#C9A84C" : "#E5E7EB" }}
                  />
                )}
                {i > 0 && (
                  <div
                    className="absolute left-0 top-1/2 h-px w-1/2 -translate-y-1/2"
                    style={{ background: state.step > i ? "#C9A84C" : "#E5E7EB" }}
                  />
                )}
                <div
                  className="relative z-10 flex h-7 w-7 items-center justify-center rounded-sm text-xs font-semibold transition-all"
                  style={{
                    background: isDone ? "#C9A84C" : isActive ? "#0C2340" : "#E5E7EB",
                ...
                <span
                  ...
                  style={{ color: isActive ? "#0C2340" : "#9CA3AF" }}
                >
                  {label}
                </span>
              </div>
